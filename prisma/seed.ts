...
async function main() {
  ...
  },
  {
      ...
      "questions": JSON.stringify([
          ...
          {
              "id": "q3",
              "label": "วารสารวิชาการ (Journal)",
              "type": "radio",
              "options": ["TCI", "Scopus","proceeding"]
          },
          { "id": "q4", "label": "ระดับ", "type": "text" },
          { "id": "q5", "label": "ชื่อผลงานตีพิมพ์", "type": "text" },
          { "id": "q6", "label": "จำนวนหน้า", "type": "number" },
          { "id": "q7", "label": "ชื่อวารสาร", "type": "text" },
          { "id": "q8", "label": "ชื่อผู้จัดหรือสำนักพิมพ์วารสาร", "type": "text" },
          { "id": "q9", "label": "ต้นทุนเฉลี่ยของงานวิจัยต่อชิ้นงานตีพิมพ์", "type": "text" },
          {
            "id": "q10",
            "label": "",
            "type": "group",
          ...
          "children": [
            {
              "id": "q11_1",
              "label": "ผลงานตีพิมพ์ในระดับนานาชาติของบัณฑิตศึกษาสามารถตอบโจทย์ 4+2 อุตสาหกรรมตามนโยบายใหม่ของรัฐบาล",
              "type": "radio",
              "options": ["ใช่", "ไม่"]
            },
            { "id": "q11_2", "label": "เซมิคอนดักเตอร์", "type": "checkbox" },
      ...
      "description": "7.3ก-35 ทักษะความรู้อุตสาหกรรมใหม่ 4+2 New S-Curve เพื่ออุตสาหกรรมมุ่งเป้าแห่งอนาคต (เกษตรสมัยใหม่และเทคโนโลยีชีวภาพ)\n7.3ก-9 ความเขี่ยวชาญเฉพาะด้านเกี่ยวกับอุตสาหกรรมเป้าหมายของประเทศ \n7.3ก-32 (7.3 กX17) ชื่ออบรมทักษะความรู้สมัยใหม่ในศตวรรษที่ 21 \n7.3ก-36 (7.3 กX19) ชื่ออบรมหลักสูตรเฉพาะทาง/ มาตรฐานในระดับประเทศหรือนานาชาติ\n7.3ก-39 (7.3 กX22) ชื่ออบรมและนำเสนอผลงานด้านเทคโนโลยีการบริหารจัดการ",
      "questions": JSON.stringify([
          { "id": "q1", "label": "ภาควิชา/สาขาวิชา", "type": "text" },
          {
            "id": "q2",
            "label": "บุคลากร",
            "type": "radio",
          ...
          { "id": "q3", "label": "คำนำหน้าชื่อ", "type": "text" },
          { "id": "q4", "label": "ชื่อ-นามสกุล", "type": "text" },
          {
            "id": "q5",
            "label": "การอบรม",
            "type": "radio",
            "options": ["การพัฒนาตามสาขาวิชาชีพ", "การพัฒนาคุณภาพการเรียนการสอน","การวิจัยเพื่อสร้างสรรค์นวัตกรรม","การบริการวิชาการและเพิ่มคุณค่า","การพัฒนาทักษะเชิงบริหารจัดการ","อบรมทักษะความรู้สมัยใหม่ในศตวรรษที่ 21 ทักษะด้านความรู้ Hard Skills ","อบรมทักษะความรู้สมัยใหม่ในศตวรรษที่ 21 ทักษะทางอารมณ์ Soft Skills "]
          },
          {
            "id": "q6",
            "label": "",
            "type": "group",
            "children": [
              { "id": "q6_1", "label": "เรื่อง", "type": "text" },
              { "id": "q6_2", "label": "ผู้จัด", "type": "text" },
              { "id": "q6_3", "label": "ระยะเวลา", "type": "text" },
              { "id": "q6_4", "label": "สถานที่", "type": "text" },
              { "id": "q6_5", "label": "ผลลัพธ์และประโยชน์ที่ได้รับ", "type": "text" },
              { "id": "q6_6", "label": "หลักฐาน", "type": "file" },
            ]
          },{
            "id": "q7",
            "label": "การอบรม",
            "type": "radio",
            "options": ["อบรมในประเทศ", "อบรมต่างประเทศ","อบรมทั้งในและต่างประเทศ"]
          },{
            "id": "q8",
            "label": "",
            "type": "group",
            "children": [
              {
                "id": "q8_1",
                "label": "การนำเสนอผลงานวิจัย",
                "type": "radio",
                "options": ["นำเสนอผลงานในประเทศ", "นำเสนอผลงานในต่างประเทศ"]
              },
              { "id": "q8_2", "label": "ชื่อนำเสนอผลงาน", "type": "text" },
            ]
          },{
            "id": "q9",
            "label": "",
            ...
            "children": [
              {
                "id": "q9_1",
                "label": "รับเชิญเป็นวิทยากร",
                "type": "radio",
                "options": ["วิทยากรในประเทศ", "วิทยากรต่างประเทศ"]
              },
              { "id": "q9_2", "label": "ชื่อโครงการไปเป็นวิทยากร", "type": "text" },
            ]
          },{
            "id": "q10",
            "label": "",
            ...
            "children": [
              {
                "id": "q10_1",
                "label": "เป็นผู้ทรงคุณวุฒิ",
                "type": "radio",
                "options": ["ผู้ทรงคุณวุฒิในประเทศ", "ผู้ทรงคุณวุฒิในต่างประเทศ"]
              },
              { "id": "q10_2", "label": "ผู้ทรงคุณวุฒิทางด้าน", "type": "text" },
            ]
          },{
            "id": "q11",
            "label": "",
            ...
            "children": [
              {
                ...
                "label": "เป็นปรึกษา",
                "type": "radio",
                "options": ["ที่ปรึกษาในประเทศ", "ที่ปรึกษาในต่างประเทศ"]
              },
              { "id": "q11_2", "label": "หน่วยงาน", "type": "text" },
            ]
          },
