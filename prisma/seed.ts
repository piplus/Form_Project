...
async function main() {
  ...
  const forms = [
    ...
    {
      "file": "RT KR 2.3",
      "description": "ข้อมูลผลงานวิจัยที่เผยแพร่ในระดับนานาชาติ พร้อมรายละเอียดการตีพิมพ์",
      "questions": JSON.stringify([
        { "id": "q1", "label": "ชื่อผลงานวิจัยที่เผยแพร่", "type": "text" },
        { "id": "q2", "label": "ชื่อ-นามสกุล เจ้าของผลงาน", "type": "text" },
        { "id": "q3", "label": "ชื่อวารสารที่เผยแพร่", "type": "text" },
    ...
    {
      "file": "RT KPI 2.2",
      "description": "ข้อมูลการถ่ายทอดองค์ความรู้ เทคโนโลยี หรือ นวัตกรรมให้แก่สถานประกอบการ และผลลัพธ์ที่เกิดขึ้น",
      "questions": JSON.stringify([
    ...
    {
      "file": "RT KPI 2.1",
      "description": "ผลงานวิจัย สิ่งประดิษฐ์ นวัตกรรม หรือองค์ความรู้ที่ถูกนำไปใช้ประโยชน์",
      "questions": JSON.stringify([
    ...
    {
      "file": "KPI 1.2 คณะ",
      "description": "ข้อมูลนักศึกษาที่ผ่านการประเมินตามมาตรฐานวิชาชีพหรือได้รับ Certificate",
      "questions": JSON.stringify([
    ...
    {
      "file": "KPI 1.1 คณะ",
      "description": "ข้อมูลนักศึกษาที่มีผลสอบสมรรถนะจากหน่วยงานภายนอก พร้อมระดับมาตรฐานที่ได้รับ",
      "questions": JSON.stringify([
        { "id": "q1", "label": "ชื่อ-นามสกุล", "type": "text" },
    ...
    {
      "file": "KPI 1.3 คณะ",
      "description": "ข้อมูลนักศึกษาที่มีผลสอบสมรรถนะในการใช้เทคโนโลยีสารสนเทศ สอดคล้องกับมาตรฐานวิชาชีพ",
      "questions": JSON.stringify([
        { "id": "q1", "label": "รหัสนักศึกษา", "type": "text" },
    ...
    {
      "file": "RT KPI 1.4 คณะ",
      "description": "ข้อมูลการสอบภาษาอังกฤษตามมาตรฐานสากลของนักศึกษา พร้อมคะแนนและช่วงเวลาการประเมิน",
      "questions": JSON.stringify([
        { "id": "q1", "label": "รหัสนักศึกษา", "type": "text" },
    ...
    {
      "file": "RT KPI 1.5 คณะ",
      "description": "ข้อมูลนักศึกษาที่เรียนภาษาต่างประเทศอื่น ๆ (นอกจากภาษาอังกฤษ)",
      "questions": JSON.stringify([
        { "id": "q1", "label": "รหัสนักศึกษา", "type": "text" },
        { "id": "q2", "label": "คำนำหน้า", "type": "text" },
        { "id": "q3", "label": "ชื่อ - นามสกุล", "type": "text" },
    ...
    {
      "file": "KPI 1.6 คณะ",
      "description": "ข้อมูลหลักสูตร รายวิชา หรือโครงการ/กิจกรรม ที่ทำให้ผู้เรียนสามารถนำ AI ไปใช้ประโยชน์ได้จริง",
      "questions": JSON.stringify([
        { "id": "q1", "label": "รหัสหลักสูตร - รายวิชา", "type": "text" },
        { "id": "q2", "label": "รายละเอียดรายวิชา", "type": "text" },
        { "id": "q3", "label": "ชื่อโครงการ/กิจกรรม", "type": "text" },
        {
          "id": "q4",
          "label": "ระบุบุคลากรที่จัดโครงการหรือเรียนการสอน",
          "type": "text"
        },
        { "id": "q5", "label": "ภาควิชา/สาขาวิชา ที่ดำเนินการ", "type": "text" },
    
        {
          ...
          "type": "group",
          "children": [
            { "id": "q6_1", "label": "ด้านสังคม/ด้านการศึกษา", "type": "text" },
            { "id": "q6_2", "label": "ด้านเศรษฐกิจ/ธุรกิจ", "type": "text" },
            { "id": "q6_3", "label": "ด้านสิ่งแวดล้อม", "type": "text" },
            { "id": "q6_4", "label": "ปัญหาที่ได้รับการแก้ไขโดย AI", "type": "text" }
          ]
        },
    
        { "id": "q7", "label": "ช่วงเวลาการจัดเก็บข้อมูล (ไตรมาส 1,2,3,4)", "type": "text" }
      ]),
    },
    {
      "file": "KPI 1.6 คณะ",
    ...
    {
      "file": "KPI 1.7 คณะ",
      "description": "ข้อมูลหลักสูตร/โครงการ/กิจกรรม ที่แสดงความเชื่อมโยงกับเป้าหมายการพัฒนาที่ยั่งยืน (SDGs)",
      "questions": JSON.stringify([
        {
          "id": "q1",
    ...
    {
      "file": "KPI 1.8 คณะ",
      "description": "ข้อมูลหลักสูตรที่ดำเนินการร่วมกับสถานประกอบการหรือภาคีภายนอก พร้อมประเภทของหลักสูตร",
      "questions": JSON.stringify([
    ...
    {
      "file": "KPI 1.9 คณะ",
      "description": "ข้อมูลหลักสูตรที่ใช้เทคโนโลยี/นวัตกรรมเพื่อพัฒนาความเป็นผู้ประกอบการ แยกตามสาขาและประเภทหลักสูตร",
      "questions": JSON.stringify([
    ...
    {
      "file": "KPI 1.10 คณะ",
      "description": "ข้อมูลกิจกรรม/โครงการที่พัฒนาหรือเตรียมความพร้อมให้นักศึกษาเป็นผู้ประกอบการ",
      "questions": JSON.stringify([
    ...
    {
      "file": "KPI 1.11 คณะ",
      "description": "ข้อมูลนักศึกษาที่ได้รับรางวัลผู้ประกอบการ (Startup Awards) จากหน่วยงานต่าง ๆ",
      "questions": JSON.stringify([
        { "id": "q1", "label": "รหัสนักศึกษา", "type": "text" },
        { "id": "q2", "label": "ชื่อ-นามสกุล", "type": "text" },
        { "id": "q3", "label": "ชั้นปี", "type": "text" },
    ...
    {
      "file": "KPI 1.12 คณะ",
      "description": "ข้อมูลนวัตกรรม/ผลงานของนักศึกษาที่ได้รับรางวัล และผลกระทบที่เกิดขึ้น",
      "questions": JSON.stringify([
        { "id": "q1", "label": "รหัสนักศึกษา", "type": "text" },
        { "id": "q2", "label": "คำนำหน้า", "type": "text" },
        { "id": "q3", "label": "ชื่อ - นามสกุล", "type": "text" },
    ...
    {
      "file": "RT KPI 2.7",
      "description": "ข้อมูลผลงานที่ยื่นขอรับการคุ้มครองทรัพย์สินทางปัญญา",
      "questions": JSON.stringify([
  ...
  },
  {
      ...
      "questions": JSON.stringify([
          ...
          { "id": "q3", "label": "สาขา", "type": "text" },
          {
              ...
              "options": [
                  { "id": "q4_1", "label": "ฝังตัว/ฝึกประสบการณ์" },
                  { "id": "q4_2", "label": "เป็นวิทยากร" },
                  { "id": "q4_3", "label": "เป็นที่ปรึกษา" },
                  { "id": "q4_4", "label": "โครงการ Talent Mobility" },
                  { "id": "q4_5", "label": "โครงการ ITAP" },
                  { "id": "q4_6", "label": "อื่นๆ" }
              ]
          },
          {
  ...
  },
  {
      ...
      "questions": JSON.stringify([
          ...
          { "id": "q3", "label": "วัน/เดือน/ปี ที่เข้ารับการอบรม", "type": "date" },
          {
              ...
              "type": "radio",  // เปลี่ยนจาก "group" เป็น "radio"
              "options": [
                  { "id": "q4_1", "label": "ระดับ 1" },
                  { "id": "q4_2", "label": "ระดับ 2" },
                  { "id": "q4_3", "label": "ระดับ 3" },
                  { "id": "q4_4", "label": "ระดับ 4" },
              ]
          },
      ]),
  },
