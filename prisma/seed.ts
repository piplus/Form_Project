...
async function main() {
  ...
  const forms = [
    ...
    },
    {
      ...
      "method" : "1.บริการวิเคราะห์, ทดสอบ, ตรวจสอบและตรวจซ่อม 2.บริการเครื่องมือและอุปกรณ์ต่าง ๆ ทางการศึกษา 3.บริการจัดฝึกอบรม, 4.สัมมนาและประชุมเชิงปฏิบัติการแบบเก็บค่าลงทะเบียน บริการจัดฝึกอบรม, 5.สัมมนาและประชุมเชิงปฏิบัติการในลักษณะการว่าจ้าง 6.บริการเกี่ยวกับสุขภาพที่นอกเหนือจากหน้าที่ความรับผิดชอบโดยตรงของหน่วยงานที่เกี่ยวข้อง 7.บริการศึกษา, วิจัย, สำรวจ, การวางแผนและการจัดการ 8.บริการศึกษาความเหมาะสมของโครงการ, การศึกษาผลกระทบสิ่งแวดล้อม 9.บริการวางระบบ, ออกแบบ, สร้าง, ประดิษฐ์และผลิต 10.งานที่ได้รับงบประมาณจากส่วนราชการอื่น โดยจัดทำสัญญาว่าจ้างระหว่างกันกับหน่วยงานภายนอก, องค์กรภาครัฐ, ภาคเอกชน, สถานประกอบการภาคอุตสาหกรรมหรือชุมชน",
      "questions": JSON.stringify([
    ...
    },
    {
      ...
      "method" : "1.รายได้จากการวิจัย (งบประมาณภายนอก) 2.รายได้จากทรัพย์สินทางปัญญา 3.รายได้จากการฝึกอบรม 4.รายได้จากการทดสอบสมรรถนะ 5.รายได้จากการบริการวิชาการ/งานที่ปรึกษา6.รายได้จากการบริการสอบเทียบ/ทดสอบ/ผลิตชิ้นงาน/ขายผลิตภัณฑ์/วิเคราะห์/ตรวจสอบ/ตรวจซ่อม 7.รายได้จากศูนย์ความเป็นเลิศ (COE) 8.บริการเครื่องมือและอุปกรณ์ต่างๆ 9.งานที่ได้รับงบประมาณจากส่วนราชการอื่นโดยจัดทำสัญญาว่าจ้างระหว่างกันกับหน่วยงานภายนอก องค์กรภาครัฐ ภาคเอกชน สถานประกอบการภาคอุตสาหกรรม หรือชุมชน",
      "questions": JSON.stringify([
        {
          "id": "q1",
    ...
    },
    {
      ...
      "method" : "1.การตีพิมพ์ในวารสารวิชาการ (Journal) ที่มีชื่อปรากฏอยู่ในฐานข้อมูล Thai-journal CitationIndex Centre (TCI) หรือ การตีพิมพ์ในวารสารวิชาการ (Journal) ที่ปรากฏในฐานข้อมูลสากล ได้แก่ ฐานข้อมูลการจัดอันดับวารสาร SJR (SCImago Journal Rank : www.scimagojr.com) หรือฐานข้อมูล Web ofScience (Science CitationIndex Expand, Social Science Citation Index, Art and Humanities CitationIndex) หรือฐานข้อมูล Scopus 2.บทความวิจัย โดยมีอาจารย์ หรือนักวิจัยจากหน่วยงาน หรือสถาบันการศึกษาจากต่างประเทศเป็นผู้ร่วมประพันธ์ที่ตีพิมพ์เผยแพร่ในฐานข้อมูลระดับนานาชาติ",
      "questions": JSON.stringify([
    ...
    },
    {
      ...
      "method" : "1.นับผลงานวิจัยตีพิมพ์ในปีงบประมาณ 2568 เท่านั้น 2.กรณีที่เป็นผลงานวิจัยของนักศึกษาที่มีชื่ออาจารย์ที่ปรึกษาในการตีพิมพ์บทความ สามารถนับได้ 3.นับผลงานที่ตีพิมพ์ในฐานข้อมูลสากล ได้แก่ ฐานข้อมูลการจัดอันดับวารสาร SJR (SCImago JournalRank : www.scimagojr.com) หรือฐานข้อมูล ISI Web of Science (Science CitationIndex Expand,Social Science Citation Index, Art and Humanities Citation Index) หรือฐานข้อมูล Scopus",
      "questions": JSON.stringify([
        { "id": "q1", "label": "ชื่อผลงานวิจัยที่เผยแพร่", "type": "text" },
        { "id": "q2", "label": "ชื่อ-นามสกุล เจ้าของผลงาน", "type": "text" },
        { "id": "q3", "label": "ชื่อวารสารที่เผยแพร่", "type": "text" },
    ...
    },
    {
      ...
      "method" : "1.มีหลักฐานสถานประกอบการที่ได้รับการถ่ายโอนองค์ความรู้ เทคโนโลยีหรือนวัตกรรมแล้วก่อให้เกิดมูลค่าเพิ่มลดรายจ่ายเพิ่มรายได้หรือช่วยแก้ปัญหา/หลักฐานเชิงประจักษ์อื่น ๆ  2.เป็นผลงานที่เกิดจากความเชี่ยวชาญของอาจารย์ สามารถก่อให้เกิดมูลค่าเพิ่มลดรายจ่ายเพิ่มรายได้หรือช่วยแก้ปัญหา ให้กับสถานประกอบการได้ เช่น ผลงานอาจารย์ที่ทำงานกับภาคอุตสาหกรรม ผลงานอาจารย์ที่เป็นที่ผู้เชี่ยวชาญในโปรแกรมการพัฒนาเทคโนโลยีของอุตสาหกรรมไทย เป็นต้น",
      "questions": JSON.stringify([
    ...
    },
    {
      ...
      "method" : "1.ชื่อ-นํามสกุลเจ้าของผลงาน สังกัดคณะวิศวกรรมศาสตร์  2.หนังสือการรับรองการนำไปใช้ประโยชน์หรือสร้างรายได้ที่ออกโดยหน่วยงานภายนอก/ภาคเอกชน/ชุมชน หรือหนังสือขอบคุณ (อย่างใดอย่างหนึ่ง) หลักฐาน หรือเอกสารแสดงการติดตํามการนำไปใช้ประโยชน์ของชุมชนในด้านต่าง ๆ  3.สัญญาอนุญาตให้ใช้สิทธิ์ในทรัพย์สินทางปัญญา หรือสัญญาอนุญาตให้ผลิต ซึ่งผลงํานวิจัยจะต้องได้รับความคุ้มครองทรัพย์สินทางปัญญาเรียบร้อย เช่น ได้รับเลขที่คำขอสิทธิบัตร หรืออนุสิทธิบัตร หรือได้รับเลขจดทะเบียนทรัพย์สินทางปัญญา",
      "questions": JSON.stringify([
    ...
    },
    {
      ...
      "method": "1.นักศึกษาทั้งหมดทุกชั้นปีของคณะ 2.ไม่นับสมรรถนะท้ายเล่มหลักสูตร 3. สอบผ่านมากกกว่า 1 มาตรฐาน สามารถนับซ้ำได้",
      "questions": JSON.stringify([
        { "id": "q1", "label": "ชื่อ-นามสกุล", "type": "text" },
    ...
    },
    {
      ...
      "method" : "1.กิจกรรมส่งเสริมการเรียนการสอนด้วยภาษาอื่น ๆ นอกเหนือจากภาษาอังกฤษ 2. ข้อมูลรายชื่อ/จำนวนนักศึกษาที่มีผลการเรียนในวิชาภาษาอื่น ๆ ที่มีชั่วโมงเรียนไม่น้อยกว่า 76 ชั่วโมงขึ้นไป ทุกPlatform ของคณะ (แสดงหลักฐํานกํารอบรม เช่น แคปหน้ําจอ ใบ Cer. )",
      "questions": JSON.stringify([
        { "id": "q1", "label": "รหัสนักศึกษา", "type": "text" },
        { "id": "q2", "label": "คำนำหน้า", "type": "text" },
        { "id": "q3", "label": "ชื่อ - นามสกุล", "type": "text" },
    ...
    },
    {
      ...
      "method" : "1.ผลงานของนักศึกษาที่เป็นผลงาน/นวัตกรรมทางวิชาการหรือวิชาชีพได้จากการออกแบบ การประดิษฐ์และสร้างสรรค์ 2. การสร้างคุณค่า หรือมูลค่าเชิงพาณิชย์ หมายถึง การลดต้นทุน ลด หรือทดแทนการนำเข้า ปรับปรุงกระบวนการผลิต พัฒนาคุณภาพ ทาผลิตภัณฑ์ใหม่ แก้ปัญหาทางเทคนิควิชาการประกอบการพัฒนาต่อยอดและอื่น ๆ ตํามวัตถุประสงค์ที่ผู้ใช้ต้องการ",
      "questions": JSON.stringify([
        { "id": "q1", "label": "รหัสนักศึกษา", "type": "text" },
        { "id": "q2", "label": "คำนำหน้า", "type": "text" },
        { "id": "q3", "label": "ชื่อ - นามสกุล", "type": "text" },
  ...
  },
  {
      ...
      "method" : "1.อาจารย์เป็นที่ปรึกษาให้กับสถานประกอบการ 2.อาจารย์ผ่านการฝึกประสบการณ์วิชาชีพในสถานประกอบการ 3.อาจารย์เป็นวิทยาการให้กับสถานประกอบการในเรื่องที่เชี่ยวชาญ 4.อาจารย์ที่เข้าร่วมโครงการ Talent mobility 5.อาจารย์ที่เข้าร่วมโครงการ ITAP",
      "questions": JSON.stringify([
          {
            "id": "q1",
            "label": "ไตรมาสที่",
